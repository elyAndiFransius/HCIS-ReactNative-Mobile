...
>
  ...
  <View className="w-full max-w-md">
    <TouchableOpacity className="bg-[#1F5EA8] rounded-xl items-center py-3 mb-3">
      <Text className="text-white font-extrabold text-base" onPress={() => router.push("/(tabs)/Pendaftaran/poli-klinik")}>Pilih Poli Tujuan</Text>
    </TouchableOpacity>

    <TouchableOpacity className="bg-gray-200 rounded-xl items-center py-3">
      <Text className="text-[#1F5EA8] font-extrabold text-base"  onPress={() => router.push("/(tabs)/Pendaftaran/pasien-umum")}>Kembali</Text>
    </TouchableOpacity>
  </View>
</ScrollView>
